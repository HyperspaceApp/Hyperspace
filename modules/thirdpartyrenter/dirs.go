...
func (r *ThirdpartyRenter) CreateDir(siaPath string) error {
	err := r.tg.Add()
	if err != nil {
		return err
	}
...
func (r *ThirdpartyRenter) DeleteDir(siaPath string) error {
	return r.staticDirSet.Delete(siaPath)
}

// DirInfo returns the Directory Information of the siadir
func (r *ThirdpartyRenter) DirInfo(siaPath string) (modules.DirectoryInfo, error) {
...
func (r *ThirdpartyRenter) DirList(siaPath string) ([]modules.DirectoryInfo, []modules.FileInfo, error) {
...
// files within func (r *ThirdpartyRenter) RenameDir(currentPath, newPath string) error {
//  return nil
// }
