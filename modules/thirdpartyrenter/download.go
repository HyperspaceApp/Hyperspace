...
func (r *ThirdpartyRenter) Download(p modules.RenterDownloadParameters) error {
...
func (r *ThirdpartyRenter) DownloadAsync(p modules.RenterDownloadParameters) error {
...
func (r *ThirdpartyRenter) managedDownload(p modules.RenterDownloadParameters) (*download, error) {
...
// parameters.
func (r *ThirdpartyRenter) managedNewDownload(params downloadParams) (*download, error) {
	// Input validation.
	if params.file == nil {
...
func (r *ThirdpartyRenter) DownloadHistory() []modules.DownloadInfo {
	r.downloadHistoryMu.Lock()
...
// all the edge cases
func (r *ThirdpartyRenter) ClearDownloadHistory(after, before time.Time) error {
