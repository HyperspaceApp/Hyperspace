...
func (r *ThirdpartyRenter) buildUnfinishedChunks(entrys []*siafile.SiaFileSetEntry, hosts map[string]struct{}) []*unfinishedUploadChunk {
...
func (r *ThirdpartyRenter) managedBuildChunkHeap(hosts map[string]struct{}) {
...
func (r *ThirdpartyRenter) managedPrepareNextChunk(uuc *unfinishedUploadChunk, hosts map[string]struct{}) {
...
func (r *ThirdpartyRenter) managedRefreshHostsAndWorkers() map[string]struct{} {
...
func (r *ThirdpartyRenter) threadedUploadLoop() {
	err := r.tg.Add()
	if err != nil {
		return
	}
